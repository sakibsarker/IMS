  ...
  return (
    <header>
      ...
      <Navbar bg="dark" variant="dark" expand="sm" collapseOnSelect>
        <Container>
          <LinkContainer to='/'>
          <Navbar.Brand>(IMS) INJURY MANAGEMENT SYSTEM</Navbar.Brand>
          </LinkContainer>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
           <Nav className="ms-auto">
            ...
            {userInfo && userInfo.isAdmin && (
              <NavDropdown title='Coaches' id='adminmenu'>
                <LinkContainer to='/admin/productlist'>
                 <NavDropdown.Item>Injury List</NavDropdown.Item>
                </LinkContainer>
                <LinkContainer to='/admin/orderlist'>
                 <NavDropdown.Item>Contact List</NavDropdown.Item>
                </LinkContainer>
                <LinkContainer to='/admin/userlist'>
                 <NavDropdown.Item>Player List</NavDropdown.Item>
                </LinkContainer>
              </NavDropdown>
            )
